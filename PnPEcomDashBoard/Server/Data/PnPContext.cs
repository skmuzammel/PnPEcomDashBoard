...
//using PnPEcomDashBoard.Server.Models;
using PnPEcomDashBoard.Shared.Models;

#nullable disable

namespace PnPEcomDashBoard.Server.Data
{
    public partial class PnPContext : DbContext
    {
        ...
        public PnPContext(DbContextOptions<PnPContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.IsDimensionsUpdatedInAx).HasDefaultValueSql("((0))");
            });
            ...
            {
                entity.Property(e => e.IsAvailableForManualRetry).HasDefaultValueSql("((0))");
            ...
            {
                entity.Property(e => e.IsAutoRetry).HasDefaultValueSql("((0))");

                entity.Property(e => e.IsAvailableForManualRetry).HasDefaultValueSql("((0))");

                entity.Property(e => e.NumberOfAutoRetries).HasDefaultValueSql("((0))");

                entity.Property(e => e.NumberOfManualRetries).HasDefaultValueSql("((0))");

                entity.Property(e => e.OrderUpdateSentToOms).HasDefaultValueSql("((0))");
            ...
            {
                entity.Property(e => e.IsActive).HasDefaultValueSql("(N'Active')");
